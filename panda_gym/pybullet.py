...
class PyBullet:
    ...
    def dt(self):
        """Timestep."""
        return self.timestep * self.n_substeps / 1
    ...
    def control_joints(self, body: str, joints: np.ndarray, target_angles: np.ndarray ,position_gains: Optional[Sequence[float]] = None,velocity_gains: Optional[Sequence[float]] = None,) -> None:
