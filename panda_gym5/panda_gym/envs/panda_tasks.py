...
from panda_gym.envs.tasks.ReachOri import ReachOri
from panda_gym.envs.tasks.Reach1 import Reach1
from panda_gym.envs.tasks.Reach2 import Reach2
...
class PandaReachOriEnv(RobotTaskEnv):
    """Reach task wih Panda robot.
    ...
    def __init__(
        ...
        sim = PyBullet(render_mode=render_mode, renderer=renderer)
        robot = Panda(sim, block_gripper=True,  control_type=control_type)
        self.robot = robot
        task = ReachOri(sim, reward_type=reward_type, get_ee_position=robot.get_ee_position,get_ee_orientation=self.robot.get_ee_orientation)
        super().__init__(
            robot,
            task,
            render_width=render_width,
...
class PandaReach1Env(RobotTaskEnv):
    """Reach task wih Panda robot.
    ...
    def __init__(
        ...
        robot = Panda(sim, block_gripper=True,  control_type=control_type)
        self.robot = robot
        task = Reach1(sim, reward_type=reward_type, get_ee_position=robot.get_ee_position,get_ee_orientation=self.robot.get_ee_orientation)
        super().__init__(
            robot,
            task,
            render_width=render_width,
...
class PandaReach2Env(RobotTaskEnv):
    """Reach task wih Panda robot.
    ...
    def __init__(
        ...
        robot = Panda(sim, block_gripper=True,  control_type=control_type)
        self.robot = robot
        task = Reach2(sim, reward_type=reward_type, get_ee_position=robot.get_ee_position,get_ee_orientation=self.robot.get_ee_orientation)
        super().__init__(
            robot,
            task,
            render_width=render_width,
